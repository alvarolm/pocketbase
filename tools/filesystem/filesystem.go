...
import (
	...
	"github.com/alvarolm/pocketbase/tools/filesystem/blob"
	"github.com/alvarolm/pocketbase/tools/filesystem/internal/fileblob"
	"github.com/alvarolm/pocketbase/tools/filesystem/internal/s3blob"
	"github.com/alvarolm/pocketbase/tools/filesystem/internal/s3blob/s3"
...
var manualExtensionContentTypes = map[string]string{
	...
	".js":  "text/javascript", // (see https://github.com/alvarolm/pocketbase/issues/6597)
	".mjs": "text/javascript",
}
